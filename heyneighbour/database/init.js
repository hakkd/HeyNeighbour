...
(async () => {
  ...
  await db.exec('INSERT INTO favours (userId, title, description, createdBy, status, date, assignedTo, jobType) VALUES (1, "Help with groceries", "I need help with groceries", 1, "open", "2021-01-01", 2, "A1A 1A1", "shopping")');
