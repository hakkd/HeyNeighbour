...
(async () => {
  ...
  await db.exec('INSERT INTO favours (title, description, createdBy, status, date, assignedTo, location) VALUES ("Help with groceries", "I need help with groceries", 1, "open", "2021-01-01", 2, "A1A 1A1")');
